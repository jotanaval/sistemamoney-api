...
public class PessoaRepositoryImpl implements PessoaRepositoryQuery{
	...
	public Page<Pessoa> filtrar(PessoaFilter pessoaFilter, Pageable pageable) {
		...
		CriteriaQuery<Pessoa> criteria = builder.createQuery(Pessoa.class);// basico
	...
	/**
	 *   No root.get("nome") usei a string no lugar do metamodel como foi mostrado em pesquisa de lancamentos  
	 * @param pessoaFilter
	 * @param builder
	 * @param root
	 * @return
